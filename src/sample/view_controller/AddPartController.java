...
import sample.model.OtherCountry;
...
public class AddPartController implements Initializable {
    ...
    @FXML
    private AnchorPane addTeaLeafId;
    ...
    void handleRadioInHouse(ActionEvent event) {
        isCountryName = false;
        this.switchLabel.setText("State:");
    ...
    void handleRadioOutSourced(ActionEvent event) {
        isCountryName = true;
        this.switchLabel.setText("Country Name:");
        ...
        try {
            ...
            if (errorMsg.length() > 0) {
                ...
                if (isCountryName == false) {
                    ...
                    partIH.setPrice(Integer.parseInt(priceTextField.getText()));
                ...
                } else if (isCountryName == true) {
                    OtherCountry partOS = new OtherCountry();
