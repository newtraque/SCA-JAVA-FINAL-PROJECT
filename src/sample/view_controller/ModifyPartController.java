...
public class ModifyPartController implements Initializable {
    ...
    void handleModifyPartSave(ActionEvent event) throws IOException {
        ...
        else if(isOtherCountry == true){
            OtherCountryPart partOS = new OtherCountryPart();
    ...
    public void initialize (URL url, ResourceBundle rb){
        ...
        else if(partToBeModified instanceof  OtherCountryPart){
            switchLabel.setText("Company Name:");
            switchTextField.setText(((OtherCountryPart) partToBeModified).getCompanyName());
            radioOutSource.setSelected(true);
        }
